...
(assert (>= z_0_t 0))
(assert (<= z_0_t 100))
(assert (>= betax_0_0 -0.0125))
(assert (<= betax_0_0 0))
(assert (>= betax_0_t -0.0125))
(assert (<= betax_0_t 0))
(assert (>= alphay_0_0 -0.025))
(assert (<= alphay_0_0 -0.0125))
(assert (>= alphay_0_t -0.025))
(assert (<= alphay_0_t -0.0125))
(assert (>= time_0 0))
(assert (<= time_0 83))
(assert (>= t_0_0 0))
(assert (<= t_0_0 83))
...
(assert 
(and 
(= [v_0_t x_0_t y_0_t z_0_t betax_0_t alphay_0_t t_0_t] (integral 0. time_0 [v_0_0 x_0_0 y_0_0 z_0_0 betax_0_0 alphay_0_0 t_0_0] flow_1))
(= betax_0_0 betax_0_t)
