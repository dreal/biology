...
public class Utility {
	 ...
	 * @param parameters
	 *            - list of parameters to synthesize
	 * @param trace
	 ...
	 *         the SMT2 file
	 */
	public static String writeSMT2ToString(SBMLDocument document, List<String> parameters,
			Trace trace, ASTNode property) {
		String output = ";This file was generated from the SBML model:  "
				+ document.getModel().getId() + "\n";
		output += "(set-logic QF_NRA_ODE)\n";
		ODEModel odeModel = new ODEModel(document, parameters);
	 ...
	 */
	public static void writeSMT2(SBMLDocument document, List<String> parameters, Trace trace,
			ASTNode property, String filename) throws IOException {
		FileOutputStream output = new FileOutputStream(filename);
		String smtFile = writeSMT2ToString(document, parameters, trace, property);
